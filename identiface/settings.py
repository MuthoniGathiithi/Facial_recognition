...
SECRET_KEY = 'django-insecure-)1ffep(aoyputl33=6^*++hy)ny5d)x(yinbimp98n@y=mur*z'
...
INSTALLED_APPS = [
    ...
    'whitenoise.runserver_nostatic',  # Disable Django's static file server in development
    'recognition',
]
